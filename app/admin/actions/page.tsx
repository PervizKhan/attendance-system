    ...
    <div className="p-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-xl border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
          ...
          {result && (
            <pre className="mt-4 p-2 rounded text-xs overflow-auto" style={{ background: 'var(--bg-primary)' }}>
        ...
        <div className="p-5 rounded-xl border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
          ...
          <p className="text-sm mb-3" style={{ color: 'var(--text-secondary)' }}>
            ...
            <br />
            <span className="text-xs opacity-70">Auto-sends at 10:00 AM daily</span>
          </p>
          <button 
      ...
      <div className="mt-6 p-4 rounded-lg border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
        ...
        <ul className="text-xs space-y-1" style={{ color: 'var(--text-secondary)' }}>
          ...
          <li>⚠️ <strong>Absent Reminders:</strong> Automatically at 10:00 AM daily</li>
